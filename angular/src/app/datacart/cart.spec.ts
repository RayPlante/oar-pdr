...
describe('DataCart', () => {
    ...
    it('save()', () => {
        ...
        dc.save();
        expect(sessionStorage.getItem("cart")).toEqual(fakecoll_json);
        expect(localStorage.getItem("cart")).toEqual('{}');
    });
    ...
    it('forget()', () => {
        ...
        expect(localStorage.getItem("cart")).toBeNull();
        dc.save();
        expect(localStorage.getItem("cart")).toEqual(fakecoll_json);
    });
    ...
    it('addFile()', () => {
        ...
        dc.addFile("foo", { filepath: "bar/goo", count: 3, downloadURL: "http://here" });
        expect(dc.size()).toEqual(1);
        expect(parseCart(localStorage.getItem("cart"))).toEqual(dc.contents);
