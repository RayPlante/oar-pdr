...
describe('NERDResource', function() {
    ...
    it("_striptypes", function() {
        ...
        expect(nerdm.NERDResource._striptypes(nrd['components'][0])).toEqual(["DataFile","Distribution"]);
    ...
    it("getComponentsByType", () => {
        ...
        expect(cmps[0]['@type']).toEqual(["nrdp:DataFile", "dcat:Distribution"]);
        expect(cmps[1]['@type']).toEqual(["nrdp:Hidden", "nrdp:AccessPage", "dcat:Distribution"]);
